...
class TextUtils{
  ...
  Text normal9(text, color, align, {height, maxLines}) {
    return Text(
      ...
      maxLines: maxLines,
      overflow: maxLines != null ? TextOverflow.ellipsis : null,
      style: TextStyle(color: color, height: height, fontSize: 9, fontWeight: FontWeight.w600, fontFamily: fontFamily),
    );
  }
  ...
  Text normal16(text, color, align, {height, maxLines}) {
    return Text(
      ...
      maxLines: maxLines,
      overflow: maxLines != null ? TextOverflow.ellipsis : null,
      style: TextStyle(color: color, height: height, fontSize: 16, fontFamily: fontFamily, fontWeight: FontWeight.w200),
    );
  }
  ...
  Text medium16(text, color, align, {height, maxLines}) {
    return Text(
      ...
      maxLines: maxLines,
      overflow: maxLines != null ? TextOverflow.ellipsis : null,
      style: TextStyle(color: color, height: height, fontSize: 16, fontWeight: FontWeight.w100, fontFamily: fontFamily),
    );
  }
  ...
  Text bold32(text, color, align, {height, maxLines}) {
    return Text(
      text,
      textAlign: align,
      maxLines: maxLines,
      overflow: maxLines != null ? TextOverflow.ellipsis : null,
      style: TextStyle(color: color, height: height, fontSize: 32, fontWeight: FontWeight.bold, fontFamily: fontFamily),
    );
  }
